...
A fonte de dados serão os arquivos dispoíveis em https://dados.recife.pe.gov.br/sv/dataset/casos-de-dengue-zika-e-chikungunya, que compreendem o registro de casos confirmados de chikungunya no período compreendido entre 2015 e 2025.
...
* NM_BAIRRO (textual, mome do bairro de residência do paciente)
* DT_OBITO (data de óbito do paciente, 5 dígitos, formato excel númerico - inteiro - para datas)

Para o escopo da análise são imprescindíveis as colunas NU_ANO, NM_BAIRRO e DT_OBITO.
